    ...
    <div className="space-y-6">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-start gap-4 flex-1">
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center p-2.5 ${provider.bgColor} border ${provider.borderColor}`}>
                      <div className={provider.id === 'slack' ? 'text-[#4A154B]' : provider.id === 'github' ? 'text-[#181717]' : ''}>
                        {provider.icon}
                      </div>
                    </div>
                    <div className="flex-1">
      ...
      <div className="flex items-center justify-center gap-3 pt-4 pb-2">
        <div className="flex items-center gap-2">
          <div className={`w-2.5 h-2.5 rounded-full ${identities.length > 0 ? 'bg-green-500' : 'bg-neutral-300'}`} />
          <span className="text-sm font-semibold text-neutral-900">
            {identities.length}
          </span>
          <span className="text-sm text-neutral-500">
            {identities.length === 1 ? 'account connected' : 'accounts connected'}
          </span>
        </div>
      </div>
    </div>
